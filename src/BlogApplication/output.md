...
> Source: `D:\Programming\BlogApplication\BlogApplication` • Generated: 2026-04-04 11:17:31

**Stats:** 26 files • 17,716 tokens
...
│   ├── post_detail.html
│   └── sidebar.html
├── BlogApplication.pyproj
├── BlogApplication.pyproj.user
├── manage.py
├── readme.html
└── requirements.txt
```
...
### 📄 `BlogApplication\__init__.py`

```python
"""
Package for BlogApplication.
"""
```
...
### 📄 `app\templates\app\loginpartial.html`
...
<body>
    ...
    <footer class="py-3 bg-grey">
        <p class="m-0 text-dark text-center ">right &copy; Django Central</p>
    </footer>
</body>
</html>
```

### 📄 `BlogApplication\settings.py`
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003" ToolsVersion="4.0">
  ...
  <PropertyGroup>
    ...
    <ProjectGuid>a2cbe19b-6611-436c-a761-a868d55bef49</ProjectGuid>
    ...
    <DjangoSettingsModule>BlogApplication.settings</DjangoSettingsModule>
  ...
  <ItemGroup>
    ...
    <Compile Include="BlogApplication\__init__.py" />
    <Compile Include="BlogApplication\settings.py" />
    <Compile Include="BlogApplication\urls.py" />
    <Compile Include="BlogApplication\wsgi.py" />
  </ItemGroup>
  <ItemGroup>
    <Folder Include="app\" />
    ...
    <Folder Include="BlogApplication\" />
  ...
  <ItemGroup>
    <Interpreter Include="env\">
      ...
      <Description>env (Python 3.14 (64-bit))</Description>
...
<body>
    ...
    <ol>
        ...
        <li>
            ...
            <img src="data:image/png;base64," />
        </li>
        <li>
